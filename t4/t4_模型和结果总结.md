...
|------|--------|------|
| **Percent** | **76.6%** | 最高匹配率 |
| **Uncertainty+Geometric** | **68.1%** | 第二高 |
| **Rank** | **56.4%** | 第三 |
| **Dynamic+JudgeSave** | **54.3%** | 最低 |

**发现**：
- **Percent方法表现最好**，匹配率达到76.6%
- Uncertainty+Geometric方法次之，68.1%
...
| 方法 | 极端命中率 | 说明 |
|------|-----------|------|
| **Uncertainty+Geometric** | **20.9%** | 最高 |
| **Percent** | **19.4%** | 第二高 |
| **Dynamic+JudgeSave** | **14.9%** | 第三 |
| **Rank** | **2.9%** | 最低 |

**发现**：
- 在极端分歧情况下，**Uncertainty+Geometric方法表现最好**（20.9%）
- Percent方法次之（19.4%）
- **Rank方法表现最差**（仅2.9%），说明排名和法不适合处理极端分歧
...
- **67周存在极端分歧**（占35.6%）
- 在极端分歧情况下，各方法表现差异显著：
  - Uncertainty+Geometric：20.9%
  - Percent：19.4%
  - Dynamic+JudgeSave：14.9%
  - Rank：2.9%
...
**数据来源**：t1/fan_vote_estimates.csv, t2_1/outputs, t3/outputs
